...
<div class="row">
    <div class="col-md-12">
    <h3 class="page-header fst-italic">Students' Cummulative Grades </h3> 
</div>
...
<a href="admin-student-printresult.php?printresult=<?php echo $row['id'];?>&viewresult=<?php echo $row['studentid'];?>" class="text-white mr-2 text-decoration-none btn btn-success btn-sm" title="print" target="_blank"> <i class="fas fa-print"></i> Print Result  </a>
</a>
<a href="admin-add-grades.php?viewstudentgrades=<?php echo $row['id'];?>&viewresult=<?php echo $row['studentid'];?>" class="text-white mr-2 text-decoration-none btn btn-dark btn-sm" title="View"><i class="fas fa-eye"></i> View Grades  </a>
</div>
</td>
</tr>
<?php } 
...
<div class="btn-group py-2 fst-italic">
<a data-bs-toggle="modal" data-bs-target="#Modal1">
<a href="admin-student-printresult.php?printresult=<?php echo $row['id'];?>&viewresult=<?php echo $row['studentid'];?>" class="text-white mr-2 text-decoration-none btn btn-success btn-sm fw-bold" title="print" target="_blank"> <i class="fas fa-print"></i> Print Result  </a>
</a>
...
<button class="btn btn-md btn-dark mt-4" type="submit" name="modaladdgrade">
