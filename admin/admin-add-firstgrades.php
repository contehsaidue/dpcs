...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-5">
      <div class="mt-5 d-flex flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      </div>
      <!-- Dashboard Main --->
 <form class="form-inline mt-5" role="form" method="POST">
 <div class="row mt-5">
    <div class="col-md-4">
...
<div class="row">
    <div class="col-md-12">
    <h3 class="page-header fst-italic">Students Grades : First Semester </h3> 
</div>
...
<div class="d-flex flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <?php 
                ...
                ?>
<!--Student First Semester Grades View Section-->
<div class="row">
<div class="col-md-12">
...
<button type="button" class="btn btn-success btn-sm fw-bold"> <i class="fas fa-th-list"></i> Add Grades </button>
</a>
