...
<html lang="en">
  <head>
    ...
    <title>Student Dashboard  · Department of Physics & Comp Sci</title>
...
<a class="navbar-brand py-3" href="#top">      
 <img src="../assets/images/nulogo.jpeg" alt="logo" width="35" height="32" class="rounded-circle me-2"><span class="text-success fw-bold">Department Of</span> <span class="fw-bold">Physics & Computer Science</span></a>
  ...
  <div class="dropdown account-section">
      ...
      <li><a class="dropdown-item" href="student-profile.php">Profile</a></li>
        <li><a class="dropdown-item" href="student-update-record.php">Settings</a></li>
